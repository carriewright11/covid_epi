...
<!-- There are two separate repos that users need to clone: -->

<!-- One is the [HopkinsIDD/COVID19_Minimal template]((https://github.com/HopkinsIDD/COVID19_Minimal){target="_blank"}), which is a template spatial repository for location-specific files. -->

<!-- The second is the HopkinsIDD/COVIDScenarioPipeline repository (usually located inside the the spatial repository folder). The manuscript describes this a little bit if it is unclear. -->

First navigate to the Johns Hopkins IDD **HopkinsIDD/COVID19_Minimal template** GitHub repository: by clicking [here.](https://github.com/HopkinsIDD/COVID19_Minimal){target="_blank"}
